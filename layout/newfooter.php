...
<footer class="py-4 py-md-5 bg-black">
    ...
    <div>
        <div class="container-fluid border-bottom border-dark pb-4 bg-dark">
            <div class="row gy-3 align-items-sm-center">
                <div class="col-12 col-sm-6 mobile-view-img ">
                    <div class="footer-logo-wrapper text-start ms-5">
                        <a href="#!">
                            <img src="assets/img/logo_43.png" alt="BootstrapBrain Logo" class="img-fluid">
                        </a>
                    </div>
                </div>
                <div class="col-12 col-sm-6  mobile-view-social">
                    <div class="social-media-wrapper me-5">
                            ...
                            <li>
                                <a href="#!" class="btn btn-outline-light bsb-btn-circle bsb-btn-circle">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                        class="bi bi-facebook text-lightx" viewBox="0 0 16 16">
                                        <path
    ...
    <section class="py-4 py-md-5 py-xl-7 py-xxl-10 bg-dark">
        <div class="container">
            <div class="row gy-4 gy-md-0">
                <div class="col-6 col-md-3 mobile-view">
                    <div class="link-wrapper">
                        <h4 class="mb-3 fw-bold fs-7 text-light">AboutUs</h4>
                        <p class="list-unstyled fs-9 " style="font-weight:400;color:#fff;">
                            Jai Ghosh Radio & Media Centre, under the Department of Culture, Uttar Pradesh, is a
                            pioneering institution dedicated to preserving and promoting the rich cultural heritage of
                            the region. Our mission is to be a beacon of cultural enlightenment, fostering creativity,
                            and providing a platform for expression through various media channels.
                        </p>
              ...
              <li>
                ...
                <div class="col-6 col-md-2 ms-5 mobile-view">
                    <div class="link-wrapper  mobile-view">
                        <h4 class="mb-3 fw-semibold fs-7 text-light">LINKS</h4>
                        <ul class="m-0 list-unstyled">
                            <li class="mb-1">
                                <a href="#!"
                ...
                <div class="col-6 col-md-3 ms-3">
                    <div class="link-wrapper  mobile-view">
                        <h4 class="mb-3 fw-bold fs-7 text-light">
                        Categories</h4>
                        <ul class="m-0 list-unstyled">
                            <li class="mb-1">
                                <a href="#!"
    ...
    <div>
        <div class="container-fluid border-top border-dark pt-4 bg-dark ">
            <div class="row gy-3 align-items-lg-center ms-5">
                <div class="col-12 col-lg-6 order-1 order-lg-0 ">
                    ...
                    <!-- <div class="credit-wrapper d-block text-light fs-8 text-start">
                        Built by<a href=""
                            class="link-opacity-0 link-opacity-75-hover link-light text-decoration-none">
                            gkshukla</a> with <span class="text-primary">&#9829;</span>
                    </div> -->
                </div>
                <div class="col-12 col-lg-6 ">
                    <div class="link-wrapper mobile-view2 ">
                        <ul
                            class="m-0 list-unstyled d-flex justify-content-centerX justify-content-lg-end gap-2 gap-md-3">
                            <li>
                                <a href="#!"
