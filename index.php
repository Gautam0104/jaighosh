 ...
 <body>
      ...
      <!-- Navbar start -->
         ...
         <!-- Navbar End -->
                 ...
                 <!-- Modal Search Start -->
        <?php include "layout/searchModal.php"; ?>
        <!-- Modal Search End -->
        ...
        <!-- Carousel End -->
                ...
                <!-- hero section start -->
         <?php include "layout/hero.php"; ?>        
                <!-- hero section end -->
                <!-- DISCLAIMER section start -->
         <?php include "layout/DISCLAIMER.php"; ?>        
                <!-- DISCLAIMER section end -->
                <div id="news">
                <?php include "layout/news.php"; ?>
                </div>
                ...
                <!-- TopStories Start -->
                <div id="topStories">
                <?php include "layout/topStories.php"; ?>   
                </div>       
                <!-- TopStories End -->
                   
                        <!-- Footer Start -->
         <?php include "layout/newfooter.php"; ?>
        <!-- Footer End -->
